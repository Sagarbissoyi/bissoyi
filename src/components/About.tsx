...
return (
    <div className="flex overflow-hidden  justify-around items-center font-mono px-28 h-[50vh] w-[45]" id="bg">
        <div className="ml-20 w-3/5 flex flex-col">
               ...
               <Button component="a" href="https://github.com/Sagarbissoyi" target="_blank" className="!text-bgColor !w-fit" size="lg" variant="filled"  color="#64FFDA">Check Resume</Button>
